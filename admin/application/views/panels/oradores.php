            ...
            <div class="box span12">
                ...
                <div class="box-content">
                    ...
                    <div class="form_container">
                        ...
                        echo control_group('Foto Orador', upload_manager("",array("id"=>$row->id, "uploadFolder"=>"uploads/oradores/", "filter"=>'jpg', "ratio"=>'400x400')),$attr = array('id'=>'uploadGroupNo', 'help-block'=>'(Imágen JPG - 205x205)'));
                        ...
                        echo control_group('Twitter', form_input($data),$attr = array('prepend'=>'<i class="icon-linkedin"></i>','append'=>'<a class="icon-question ax-modal tip-right" data-original-title="Ver ayuda" href="'.base_url('helps/general/2').'"></a>'));
