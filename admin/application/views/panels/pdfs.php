...
<?php echo $this->view('layout/panels/box_header', array('title'=>'PDFs', 'icon'=>'icon-pencil')) ?>
<div class="box-content">
<?php $this->view('alerts/error') ?>
<?php
$data = array ('id'=>'pdfsForm', 'class'=>'form-horizontal');
...
echo control_group('Portada', upload_manager("",array("id"=>$row->id, "pos"=>'portada', "uploadFolder"=>"uploads/pdf/", "filter"=>'jpg')),$attr = array());
echo control_group('PDF', upload_manager("",array("id"=>$row->id, "pos"=>'pdf', "uploadFolder"=>"uploads/pdf/", "filter"=>'pdf')),$attr = array());
...
$buttons .= '<span class="">';
$data = array('type'=>'submit', 'value'=>'Guardar', 'class'=>'btn btn-primary', 'onclick'=>"validateForm('pdfsForm')", 'style' =>'margin-right: 10px');
