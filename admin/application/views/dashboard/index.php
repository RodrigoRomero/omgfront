...
<div class="row-fluid">
	<div class="span3 box">
        <div class="box-header">
    	   <h2><i class="icon-pencil"></i>Almuerzos Vendidos</h2>
        </div>
        <div class="box-content text-center" style="background: #f6f6f6;">
            <div class="span6 offset3" style="border: 2px solid #fff; padding: 30px; display:inline-block; border-radius: 10px; background: #36A9E1;">
                <h1 style="color: #ffffff;">
...
<div class="row-fluid">
	<div class="span3 box">
        <div class="box-header">
    	   <h2><i class="icon-pencil"></i>Ordenes</h2>
        </div>
        <div class="box-content text-center" style="background: #f6f6f6;">
            <div class="span6 offset3" style="border: 2px solid #fff; padding: 30px; display:inline-block; border-radius: 10px; background: #36A9E1;">
                <h1 style="color: #ffffff;">
    ...
    <div class="span3 box">
		<div class="box-header">
			<h2><i class="icon-pencil"></i>Ordenes Estados</h2>
		</div>
		<div class="box-content">
			<table class="table table-striped">
				<?php foreach($total_orders_status as $orders){ ?>
				<tr>
